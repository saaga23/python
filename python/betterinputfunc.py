...
def get_int_in_range(first, last):
    ...
    first is either a minimum or maaximu acceptable value.
    last is the corresponfing other end of the range, either a maximum value.
    ...
    # Insit on values in the range first...last
